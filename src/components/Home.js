...
export default function Home() {
         ...
         <div className="back">
          ...
          <img src={tree} alt="trees over bg" className=" w-100 img-fluid " style={{background:'transparent'}}/>
            ...
            <div className="front float-right-top d-flex">
             <a className="btn mx-1 btn-dark bg-accent front rounded-circle border-0" href="#" role="button"><FaDiscord/></a>
             <a className="btn mx-1 btn-dark bg-accent2 front rounded-circle border-0" href="#" role="button"><FaTelegram/></a>
            </div>
            <section className="front  mx-auto my-auto d-flex flex-column justify-content-center align-items-center  w-100  ">
              
          
         <img src={brand} alt="VapoBlitz" className="front img-fluid w-25" />
               <hr color="#fff"/>
    ...
    <Container fluid className="  d-flex flex-column py-5 px-1 bg-section1" >
      <h3 className="text-center text-white fs-2 pb-3">What is Vaporblitz?</h3>
        <p className="text-center align-self-center text-white fs-5 fw-light w-75  px-1">
...
to make money in the process.
    ...
    <Container fluid className="  d-flex flex-column py-5 px-1 bg-section2" >
        ...
        <Container>
         ...
         <Row>
             <Col md={3} className="d-flex justify-content-center align-items-center  ">
                 <div className=""><img src={gun1} className="img-fluid w-75 p-3  "/></div>
             </Col>
             <Col md={3} className="d-flex justify-content-center align-items-center ">
             <div className=""><img src={gun2} className="img-fluid w-75 p-3  "/></div>
         </Col>
             <Col md={3} className="d-flex justify-content-center align-items-center ">
             <div className=""><img src={gun3} className="img-fluid w-75 p-3  "/></div>
         </Col>
             <Col md={3} className="d-flex justify-content-center align-items-center ">
             <div className=""><img src={gun4} className="img-fluid w-75 p-3  "/></div>
         </Col>
         ...
         <Row>
             <Col md={3} className="d-flex justify-content-center align-items-center  ">
                 <div className=""><img src={acc1} className="img-fluid w-75 p-3  "/></div>
             </Col>
             <Col md={3} className="d-flex justify-content-center align-items-center ">
             <div className=""><img src={acc2} className="img-fluid w-75 p-3  "/></div>
         </Col>
             <Col md={3} className="d-flex justify-content-center align-items-center ">
             <div className=""><img src={acc3} className="img-fluid w-75 p-3  "/></div>
         </Col>
             <Col md={3} className="d-flex justify-content-center align-items-center ">
             <div className=""><img src={acc4} className="img-fluid w-75 p-3  "/></div>
         </Col>
    ...
    <Container fluid className="  d-flex flex-column py-5 px-1 bg-section1" >
      <h3 className="text-center text-white fs-2 pb-3">Complete PVP System</h3>
        ...
        <Row>
             ...
             <div className="d-flex flex-column justify-content-center align-items-center"><img src={fun1} className="img-fluid w-75 p-3  "/>
         ...
         <Row><h4 className="text-white text-center mt-5">Fight On Different Maps</h4>
           </Row>
    </Container>
    <Container fluid className="  d-flex flex-column py-5 px-1 bg-section2" >
      <h3 className="text-center text-white fs-2 pb-3">Fight Bosses for VPR</h3>
        ...
        <Row>
             <Col md={4} className="d-flex justify-content-center align-items-center  ">
             <div className="d-flex flex-column justify-content-center align-items-center"><img src={boss1} className="img-fluid w-75 p-3  "/>
             <h4 className="text-white">Signal Killer</h4>
             
             </div>
         </Col>
             <Col md={4} className="d-flex justify-content-center align-items-center ">
             <div className="d-flex flex-column justify-content-center align-items-center"><img src={boss2} className="img-fluid w-75 p-3  "/>
             <h4 className="text-white">Fruit Snatcher</h4></div>
          </Col>
             <Col md={4} className="d-flex justify-content-center align-items-center ">
             <div className="d-flex flex-column justify-content-center align-items-center"><img src={boss3} className="img-fluid w-75 p-3  "/>
        ...
        <p className="mt-3 text-center align-self-center text-white fs-5 fw-light w-75  px-1">
...
abilities. After beating a boss you are rewarded with $VPR.</p>
    ...
    <Container fluid className="  d-flex flex-column py-5 px-1 bg-section3" >
